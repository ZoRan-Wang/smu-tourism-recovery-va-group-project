...
The fitted model produces three interpretable groups, with the high-performance state containing the largest number of months.
...
This table confirms the storytelling logic of the model: the high-performance state covers all pre-COVID months and many recovery months, while the shock and transition states capture the disturbed part of the tourism timeline.
