              ...
              layout_columns(
                card(
                  ...
                  card_body(
                    ...
                    plotly::plotlyOutput(ns("dashboard_pattern_plot"), height = "440px")
                  )
                ),
                card(
                  class = "cluster-panel",
                  ...
                  card_body(
                    ...
                    plotly::plotlyOutput(ns("cluster_profile_plot"), height = "440px")
                  )
                ),
                col_widths = c(7, 5)
              )
            ...
            div(
              ...
              card(
                ...
                card_body(
                  ...
                  plotly::plotlyOutput(ns("pattern_explorer_plot"), height = "500px")
                )
              ),
              card(
                class = "cluster-panel",
              ...
              layout_columns(
                card(
                  ...
                  card_body(
                    ...
                    plotly::plotlyOutput(ns("china_recovery_plot"), height = "500px")
                  )
                ),
                card(
                  class = "cluster-panel",
              ...
              layout_columns(
                card(
                  ...
                  card_body(
                    ...
                    plotly::plotlyOutput(ns("china_focus_plot"), height = "430px")
                  )
                ),
                card(
                  class = "cluster-panel",
