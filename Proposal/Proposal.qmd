...
1. inspect the selected arrivals series through trend, seasonal, and decomposition views
2. create a time-aware train/test split
3. compare a baseline seasonal-naive forecast against ETS and ARIMA
4. evaluate forecast quality with holdout metrics such as RMSE, MAE, and MAPE
5. interpret the demand forecast against supporting tourism indicators such as hotel occupancy, stay length, and room revenue
