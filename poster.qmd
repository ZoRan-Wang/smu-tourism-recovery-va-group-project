...
The visual analysis shows that Singapore's visitor market remains concentrated in a small group of major source countries, with strong weight in the Asia-Pacific region. The pre-COVID ranking and the recovery-period ranking share a stable core, yet the relative size of these markets changes after the shock. This pattern indicates that the market portfolio recovered with structural persistence but incomplete volume recovery.
...
*The leading source-market portfolio remains stable after COVID, while average monthly arrivals stay below the earlier baseline and the ranking among major countries changes.*
:::
:::
